...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // Symbols enabled
  [0] = LAYOUT(
    // KC_PSCR,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_VOLD,  KC_VOLU,  KC_DEL,
    RESET,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_VOLD,  KC_VOLU,  KC_DEL,
    ...
    // KC_LCTL,  KC_LGUI,  KC_LALT,  KC_SPC,   KC_RSFT,   KC_RGUI,     LT(1, KC_MPLY), MT(MOD_RALT, KC_MPRV),  MT(MOD_RCTL, KC_MNXT),  KC_LEFT,  KC_DOWN,  KC_RGHT
    KC_LCTL,  KC_LGUI,  KC_LALT,  KC_SPC,   KC_RSFT,   KC_RGUI,     KC_MPLY, KC_MPRV,  KC_MNXT,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  /*   KC_ESC,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,                      KC_ENT,   KC_PGDN, */
  /*   KC_LSFT,  KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            KC_UP,    KC_END, */
  /*   KC_LCTL,  KC_LALT,  KC_LGUI,  KC_SPC,   MO(2),   KC_RGUI,     LT(1, KC_MPLY), MT(MOD_RALT, KC_MPRV),  MT(MOD_RCTL, KC_MNXT),  KC_LEFT,  KC_DOWN,  KC_RGHT */
  /* ), */
  ...
  [2] = LAYOUT(
    ...
    _______,  KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  _______,  _______,  KC_LPRN,  KC_RPRN,  KC_MINS,  KC_COLN,  KC_DQUO,                      _______,  _______,
    _______,  _______,  _______,  _______,  KC_GRV,   KC_TILD,  _______,  KC_EQL,  KC_LCBR,  KC_RCBR,  KC_PIPE,  KC_BSLS,  _______,  _______,            _______,
...
/* static bool tmux_key_held = false; */
/*  */
/* void register_shifted(uint16_t keycode) { */
...
/*   if (keycode == KC_INT1) { */
/*     tmux_key_held = record->event.pressed; */
/*     return false; */
/*   } */
/*  */
/*   if (tmux_key_held && record->event.pressed) { */
...
/*     switch (keycode) { */
/*       case KC_F1 ... KC_F10: */
/*         register_shifted(KC_1 + keycode - KC_F1); */
/*         return false; */
/*  */
/*       case KC_F11: */
